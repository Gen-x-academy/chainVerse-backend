...
export const httpRequestDuration = new client.Histogram({
  name: 'chainverse_http_request_duration_seconds',
...
export const httpRequestTotal = new client.Counter({
  name: 'chainverse_http_requests_total',
...
export const httpRequestsInProgress = new client.Gauge({
  name: 'chainverse_http_requests_in_progress',
...
export const databaseQueryDuration = new client.Histogram({
  name: 'chainverse_database_query_duration_seconds',
...
export const activeConnections = new client.Gauge({
  name: 'chainverse_active_connections',
...
export const userSignups = new client.Counter({
  name: 'chainverse_user_signups_total',
  help: 'Total number of user signups',
  registers: [register],
});

export const activeUsers = new client.Gauge({
  name: 'chainverse_active_users',
...
export const jobDuration = new client.Histogram({
  name: 'chainverse_job_duration_seconds',
...
export const jobSuccessTotal = new client.Counter({
  name: 'chainverse_job_success_total',
...
export const jobFailureTotal = new client.Counter({
  name: 'chainverse_job_failure_total',
...
export const externalCallDuration = new client.Histogram({
  name: 'chainverse_external_call_duration_seconds',
